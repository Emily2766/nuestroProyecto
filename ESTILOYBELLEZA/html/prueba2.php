...
<head>
    ...
    <link rel="stylesheet" href="/ESTILOYBELLEZ/css/usuario.css">
    ...
    <article class="bloque_1">
        <div class="agendamiento1">
            <div class="imagen_agendamiento">
                <img class="imagen_agendamiento" src="/ESTILOYBELLEZA/img/nosotros3.jpg" alt=" Foto de nosotros">
     ...
     <article class="bloque_2">
        <img class="imagen_tarjeta2" src="/ESTILOYBELLEZA/img/Logo Estilo y Belleza.jpg" alt="">
    </div>
...
<div id="total">Total: $<span id="total-valor">0</span></div>
 <script src="/ESTILOYBELLEZA/js/usuario.js"></script>
 ...
 <article class="bloque_6">
    <div class="empleado_1">
        <div class="foto_emp_1">
            <img class="empleado_mujer_1" src="/ESTILOYBELLEZA/img/estilista_mujer_1.jpg" alt="aqui va una foto de la estilista"><br><br>
    ...
    <div class="empleado_2">
        <div class="foto_emp_2">
            <img class="empleado_hombre" src="/ESTILOYBELLEZA/img/estilista_hombre.jpg" alt="aqui va una foto de la estilista"><br><br>
    ...
    <div class="empleado_3">
        <div class="foto_emp_3">
            <img class="empleado_mujer_2" src="/ESTILOYBELLEZA/img/estilista_mujer_2.jpg" alt="aqui va una foto de la estilista"><br><br>
    ...
    <div class="empleado_4">
        <div class="foto_emp_4">
            <img class="cualquier_profesional" src="/ESTILOYBELLEZA/img/foto otro estilista.jpg" alt="aqui va una foto de la estilista"><br><br>
