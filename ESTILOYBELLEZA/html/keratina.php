...
<head>
    ...
    <link rel="stylesheet" href="../css/keratina.css">
    ...
    <article class="container_1">
        <div class="liso">
            <div class="imagen_liso">
                <img class="imagen_liso" src="../img/nosotros3.jpg" alt="foto de Nosotros">
     ...
     <article class="container_2">
        <img class="imagen_keratina" src="../img/keratina_dama.jpg" alt="">
